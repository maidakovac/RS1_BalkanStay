    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 9, 1, new DateTime(2025, 3, 2, 12, 16, 36, 764, DateTimeKind.Utc).AddTicks(6616), 2, new byte[0], "061-000-111" },
                    { 10, 2, new DateTime(2025, 3, 2, 12, 16, 36, 764, DateTimeKind.Utc).AddTicks(6850), 2, new byte[0], "061-000-222" },
                    { 11, 3, new DateTime(2025, 3, 2, 12, 16, 36, 764, DateTimeKind.Utc).AddTicks(6853), 1, new byte[0], "061-000-333" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 5, 1, new DateTime(2025, 3, 2, 12, 16, 36, 764, DateTimeKind.Utc).AddTicks(5041), 1, null, "+38761000111" },
                    { 6, 2, new DateTime(2025, 3, 2, 12, 16, 36, 764, DateTimeKind.Utc).AddTicks(5311), 2, null, "+38761000222" },
                    { 7, 3, new DateTime(2025, 3, 2, 12, 16, 36, 764, DateTimeKind.Utc).AddTicks(5333), 1, null, "+38761000222" },
                    { 8, 4, new DateTime(2025, 3, 2, 12, 16, 36, 764, DateTimeKind.Utc).AddTicks(5335), 2, null, "+38761000222" }
                });
