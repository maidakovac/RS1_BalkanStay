        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OwnerApartments_Account_AccountID",
                        column: x => x.AccountID,
                        principalTable: "Account",
                        principalColumn: "AccountID");
                    table.ForeignKey(
                        ...
                        principalColumn: "ApartmentId");
                    table.ForeignKey(
                        name: "FK_OwnerApartments_Owner_OwnerAccountID",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 9, 1, new DateTime(2025, 1, 3, 21, 3, 3, 299, DateTimeKind.Utc).AddTicks(1708), 2, new byte[0], "061-000-111" },
                    { 10, 2, new DateTime(2025, 1, 3, 21, 3, 3, 299, DateTimeKind.Utc).AddTicks(1836), 2, new byte[0], "061-000-222" },
                    { 11, 3, new DateTime(2025, 1, 3, 21, 3, 3, 299, DateTimeKind.Utc).AddTicks(1852), 1, new byte[0], "061-000-333" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 5, 1, new DateTime(2025, 1, 3, 21, 3, 3, 299, DateTimeKind.Utc).AddTicks(784), 1, null, "+38761000111" },
                    { 6, 2, new DateTime(2025, 1, 3, 21, 3, 3, 299, DateTimeKind.Utc).AddTicks(960), 2, null, "+38761000222" },
                    { 7, 3, new DateTime(2025, 1, 3, 21, 3, 3, 299, DateTimeKind.Utc).AddTicks(962), 1, null, "+38761000222" },
                    { 8, 4, new DateTime(2025, 1, 3, 21, 3, 3, 299, DateTimeKind.Utc).AddTicks(963), 2, null, "+38761000222" }
                });
