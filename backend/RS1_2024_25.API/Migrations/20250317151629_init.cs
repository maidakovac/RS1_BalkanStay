    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 9, 1, new DateTime(2025, 3, 17, 15, 16, 27, 405, DateTimeKind.Utc).AddTicks(7155), 2, new byte[0], "061-000-111" },
                    { 10, 2, new DateTime(2025, 3, 17, 15, 16, 27, 405, DateTimeKind.Utc).AddTicks(7511), 2, new byte[0], "061-000-222" },
                    { 11, 3, new DateTime(2025, 3, 17, 15, 16, 27, 405, DateTimeKind.Utc).AddTicks(7517), 1, new byte[0], "061-000-333" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 5, 1, new DateTime(2025, 3, 17, 15, 16, 27, 405, DateTimeKind.Utc).AddTicks(4689), 1, null, "+38761000111" },
                    { 6, 2, new DateTime(2025, 3, 17, 15, 16, 27, 405, DateTimeKind.Utc).AddTicks(5135), 2, null, "+38761000222" },
                    { 7, 3, new DateTime(2025, 3, 17, 15, 16, 27, 405, DateTimeKind.Utc).AddTicks(5141), 1, null, "+38761000222" },
                    { 8, 4, new DateTime(2025, 3, 17, 15, 16, 27, 405, DateTimeKind.Utc).AddTicks(5146), 2, null, "+38761000222" }
                });
