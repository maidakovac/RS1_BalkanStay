            ...
            modelBuilder.Entity("RS1_2024_25.API.Data.Models.Auth.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Username = "johndoe",
                            CityID = 1,
                            CreatedAt = new DateTime(2025, 3, 1, 20, 48, 16, 998, DateTimeKind.Utc).AddTicks(3455),
                            GenderID = 1,
                            Phone = "+38761000111"
                        },
                        new
                        {
                            ...
                            Username = "janedoe",
                            CityID = 2,
                            CreatedAt = new DateTime(2025, 3, 1, 20, 48, 16, 998, DateTimeKind.Utc).AddTicks(3719),
                            GenderID = 2,
                            Phone = "+38761000222"
                        },
                        new
                        {
                            ...
                            Username = "xxxxx",
                            CityID = 3,
                            CreatedAt = new DateTime(2025, 3, 1, 20, 48, 16, 998, DateTimeKind.Utc).AddTicks(3739),
                            GenderID = 1,
                            Phone = "+38761000222"
                        },
                        new
                        {
                            ...
                            Username = "yyyy",
                            CityID = 4,
                            CreatedAt = new DateTime(2025, 3, 1, 20, 48, 16, 998, DateTimeKind.Utc).AddTicks(3741),
                            GenderID = 2,
                            Phone = "+38761000222"
                        });
                });
            ...
            modelBuilder.Entity("RS1_2024_25.API.Data.Owner", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Username = "Izel",
                            CityID = 1,
                            CreatedAt = new DateTime(2025, 3, 1, 20, 48, 16, 998, DateTimeKind.Utc).AddTicks(5032),
                            GenderID = 2,
                            Image = new byte[0],
                            Phone = "061-000-111"
                        },
                        new
                        {
                            ...
                            Username = "Maida",
                            CityID = 2,
                            CreatedAt = new DateTime(2025, 3, 1, 20, 48, 16, 998, DateTimeKind.Utc).AddTicks(5272),
                            GenderID = 2,
                            Image = new byte[0],
                            Phone = "061-000-222"
                        },
                        new
                        {
                            ...
                            Username = "Admin",
                            CityID = 3,
                            CreatedAt = new DateTime(2025, 3, 1, 20, 48, 16, 998, DateTimeKind.Utc).AddTicks(5274),
                            GenderID = 1,
                            Image = new byte[0],
                            Phone = "061-000-333"
                        });
